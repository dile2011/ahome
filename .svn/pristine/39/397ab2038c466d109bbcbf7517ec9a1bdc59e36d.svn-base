...
+ (id)resultSetWithStatement:(AStatement *)statement usingParentDatabase:(ADatabase*)aDB {
    
    AResultSet *rs = [[AResultSet alloc] init];
...
- (void)setParentDB:(ADatabase *)newDb {
    parentDB = newDb;
}
...
- (void)setStatement:(AStatement *)value {
    if (statement != value) {
        [statement release];
