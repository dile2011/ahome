...
- (void)initializer
{
    ...
    self.cellScrollView.bounces = YES;
    self.cellScrollView.scrollEnabled = YES;
    
    _contentCellView = [[UIView alloc] init];
    [self.cellScrollView setBackgroundColor:[UIColor colorWithRed:239./255 green:239./255 blue:239./255 alpha:1.]];
    [_contentCellView setBackgroundColor:[UIColor whiteColor]];
