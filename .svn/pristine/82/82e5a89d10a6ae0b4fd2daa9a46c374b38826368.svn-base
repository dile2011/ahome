...
- (void)layoutSubviews {
    ...
    _badgeLabel.frame = CGRectIntegral(CGRectMake(rect.size.width - badgeTextSize.width, ((rect.size.height - badgeTextSize.height) / 2)+1, badgeTextSize.width, badgeTextSize.height));
