...
- (void)setOTextField:(QTextField*)otherTextField element:(QElement*)element {
    otherTextField.prefix = _entryElement.prefix;
    otherTextField.suffix = _entryElement.suffix;
    
    otherTextField.autocapitalizationType = _entryElement.autocapitalizationType;
    otherTextField.autocorrectionType = _entryElement.autocorrectionType;
    otherTextField.keyboardType = _entryElement.keyboardType;
    otherTextField.keyboardAppearance = _entryElement.keyboardAppearance;
    otherTextField.secureTextEntry = _entryElement.secureTextEntry;
    otherTextField.clearsOnBeginEditing = _entryElement.clearsOnBeginEditing;
    otherTextField.contentVerticalAlignment = UIControlContentVerticalAlignmentCenter;
    otherTextField.textAlignment = _entryElement.appearance.entryAlignment;
    
    otherTextField.returnKeyType = _entryElement.returnKeyType;
    otherTextField.enablesReturnKeyAutomatically = _entryElement.enablesReturnKeyAutomatically;
    
    QAppearance *appearance = element.appearance;
    otherTextField.font = appearance.entryFont;
    otherTextField.textColor = element.enabled ? appearance.entryTextColorEnabled : appearance.entryTextColorDisabled;
}
