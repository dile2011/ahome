...
- (UITableViewCell *)getCellForTableView:(QuickDialogTableView *)tableView controller:(QuickDialogController *)controller {
    ...
    cell.badgeLabel.textColor = self.appearance.entryTextColorEnabled;
    cell.badgeLabel.badgeColor = [UIColor clearColor];
    cell.badgeLabel.font = [UIFont systemFontOfSize:16];
