...
- (id)initWithURL:(NSURL *)newURL
{
    ...
    NSString *random12 = [EncryptAndDecryptTool randomTo12];
    [self setPostValue:random12 forKey:@"key"];
    
    NSString *timeSp = [NSString stringWithFormat:@"%ld", (long)[[NSDate date] timeIntervalSince1970]];
    NSString *key = [NSString stringWithFormat:@"%@%@%@",KEY_PREFIX,random12,KEY_SUFFIX];
    NSString *encryTimeSp = [EncryptAndDecryptTool tripleDES:timeSp encryptOrDecrypt:kCCEncrypt key:key];
    
    [self setPostValue:encryTimeSp forKey:@"cert"];
