...
+(UIImage *)sd_animatedGIFNamed:(NSString *)name duration:(CGFloat)mDuration{
    ...
    if (scale > 1.0f)
    {
        ...
        if (data)
        {
            return [UIImage sd_animatedGIFWithData:data duration:mDuration];
        }
...
+ (UIImage *)sd_animatedGIFWithData:(NSData *)data duration:(CGFloat)mDuration
{
    if (!data)
    {
        return nil;
