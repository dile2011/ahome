...
@implementation ANextActionButtonElementView
...
- (void)setButtonEnable:(BOOL)enable {
    ...
    if (enable) {
        [nextButton setBackgroundImage:[UIImage imageNamed:@"Button_Orange_Def.png"] forState:UIControlStateNormal];
        [nextButton setBackgroundImage:[UIImage imageNamed:@"Button_Orange_Sel.png"] forState:UIControlStateHighlighted];
    } else {
        [nextButton setBackgroundImage:[UIImage imageNamed:@"Button_Disenable.png"] forState:UIControlStateNormal];
        [nextButton setBackgroundImage:[UIImage imageNamed:@"Button_Disenable.png"] forState:UIControlStateHighlighted];
    }
